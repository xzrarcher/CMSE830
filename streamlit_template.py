'''
----------- Welcome to the Streamlit template -----------
					Made by Mısra Turp
...
IF YOU'D LIKE TO DEPLOY YOUR APP:
Follow this tutorial: https://www.youtube.com/watch?v=B0MUXtmSpiA
...
You can get more information on everything on the Streamlit documentation: https://docs.streamlit.io/library/api-reference
...
with header_container:
	...
	st.write("Check it out yourself, if you don't believe me")
...
with stats_container:
	...
	# I have a YouTube tutorial that can help you with this: https://youtu.be/CYi0pPWQ1Do
	...
	# Visit https://docs.streamlit.io/library/api-reference for more information on what other plots and charts are possible
